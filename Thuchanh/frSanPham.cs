...
namespace Thuchanh
{
    public partial class frSanPham : Form
    {
        ...
        public static string constr = "Data Source=ADMIN\\SQLEXPRESS;Initial Catalog=KinhDoanhMayTinh;Integrated Security=True";
        ...
        private void frSanPham_Load(object sender, EventArgs e)
        {
            using (SqlConnection conn = new SqlConnection(constr))
            {
                conn.Open();
                cbBoxLoad();
                using (SqlCommand cmd = new SqlCommand("SELECT * FROM tblSanPham", conn))
                {
